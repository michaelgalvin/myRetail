...
class ProductServiceUnitTest extends GroovyTestCase {
    ...
    public static final String ID_NOT_FOUND_MSG = "The product id \'" + INVALID_ID + "\' was not found in MyRetail. Please check that you have a valid tcin."
    ...
    void testGetMyRetailJSON() {
        String msg = shouldFail(IdNotFoundException) {
